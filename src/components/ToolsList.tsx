                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-xs sm:text-sm lg:text-base text-gray-600 mt-1 sm:mt-2">
                                    发现最适合你的AI编程工具 • 共 {tools.length} 个工具
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 self-start sm:self-center flex-shrink-0">
                            ...
                            <div className="flex bg-gray-100 rounded-lg p-0.5 sm:p-1">
                                <button
                                    ...
                                    className={`px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all duration-200 flex items-center gap-1 whitespace-nowrap ${sortBy === 'recent'
                                ...
                                <button
                                    ...
                                    className={`px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all duration-200 whitespace-nowrap ${sortBy === 'name'
                                        ? 'bg-white text-primary-600 shadow-soft'
                                        : 'text-gray-600 hover:text-gray-900'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all duration-200 whitespace-nowrap ${sortBy === 'category'
                                        ? 'bg-white text-primary-600 shadow-soft'
                                        : 'text-gray-600 hover:text-gray-900'
                                        }`}
                                >
