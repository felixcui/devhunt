              ...
              <div className="flex-1 min-w-0 w-full">
                ...
                <div className="flex flex-col gap-3 sm:gap-4 mb-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 bg-gradient-to-r from-blue-500 to-green-500 text-white px-4 py-2 rounded-full text-xs sm:text-sm font-medium shadow-soft hover:from-blue-600 hover:to-green-600 transition-all duration-200 hover:scale-105 self-start"
                  >
